...
::card-group
  ...
  ---
  Write plugins in C# with Plugify's .NET language module.
  ::
  ...
  ---
  Write lightweight, embeddable scripts with Plugify's Lua language module.
  ::
  ...
  ---
  Develop plugins in Rust with Plugify's Rust language module.
  ::
  ...
  ---
  *Coming soon.* Develop plugins in Dlang with Plugify's Dlang language module.
  ::
