...
2. **For Developers**:
   ...
   - Refer to the [documentation](/essentials/installation) for detailed integration instructions.
::
...
- **C#**: Support for the .NET runtime. *(The Mono module is deprecated and no longer maintained.)*
...
#content
Our community publishes plugins on the official [Discord server](https://discord.gg/rX9TMmpang). You can also explore the [Example Plugins](https://github.com/untrustedmodders/plugify/tree/main/examples) repository for sample plugins and language modules.
::
...
Refer to the [Language Module Development Guide](/developer-guides/writing-language-module) for detailed instructions.
::
...
- [Discord Server](https://discord.gg/rX9TMmpang): Get real-time help from the community and developers.
...
Refer to the [Requirements](/introduction/requirements) section for more details.
::
