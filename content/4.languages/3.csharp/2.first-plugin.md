...
3. The compiled `.dll` file will be located in the `bin/Debug/net10.0` or `bin/Release/net10.0` folder.
...
Once your plugin loads and runs correctly, it's ready for use. If something isn't working, see the [Debugging](/languages/csharp/debugging) guide.
