...
Visit [plugify-gen tool](https://gen.plugify.net/) to generate bindings through a user-friendly web interface. Simply upload your plugin manifest file (`.pplugin`) and select C# as the target language to generate the corresponding C# module.
...
- Add the generated `.cs` files to your C# project.
::
...
### **Add to .csproj**
Add the generated files to your `.csproj`:
```xml
<ItemGroup>
...
### **Using Namespace**
Use the generated namespace in your C# files:
```csharp
