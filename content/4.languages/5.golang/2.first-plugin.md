...
* `language`: Should be set to **golang** for Go plugins.
...
Once your plugin loads and runs correctly, it's ready for use. If something isn't working, see the [Debugging](/languages/golang/debugging) guide.
