...
| plg::any                   | any              | any           | ✅             |
| plg::vector\<bool\>        | table[boolean]   | bool[]        | ✅             |
| plg::vector\<char\>        | table[string]    | char8[]       | ✅             |
| plg::vector\<char16_t\>    | table[string]    | char16[]      | ✅             |
| plg::vector\<int8_t\>      | table[number]    | int8[]        | ✅             |
| plg::vector\<int16_t\>     | table[number]    | int16[]       | ✅             |
| plg::vector\<int32_t\>     | table[number]    | int32[]       | ✅             |
| plg::vector\<int64_t\>     | table[number]    | int64[]       | ✅             |
| plg::vector\<uint8_t\>     | table[number]    | uint8[]       | ✅             |
| plg::vector\<uint16_t\>    | table[number]    | uint16[]      | ✅             |
| plg::vector\<uint32_t\>    | table[number]    | uint32[]      | ✅             |
| plg::vector\<uint64_t\>    | table[number]    | uint64[]      | ✅             |
| plg::vector\<uintptr_t\>   | table[number]    | ptr64[]       | ✅             |
| plg::vector\<uintptr_t\>   | table[number]    | ptr32[]       | ✅             |
| plg::vector\<float\>       | table[number]    | float[]       | ✅             |
| plg::vector\<double\>      | table[number]    | double[]      | ✅             |
| plg::vector\<plg::string\> | table[string]    | string[]      | ✅             |
| plg::vector\<plg::any\>    | table[any]       | any[]         | ✅             |
| plg::vector\<plg::vec2\>   | table[Vector2]   | vec2[]        | ✅             |
| plg::vector\<plg::vec3\>   | table[Vector3]   | vec3[]        | ✅             |
| plg::vector\<plg::vec4\>   | table[Vector4]   | vec4[]        | ✅             |
| plg::vector\<plg::mat4x4\> | table[Matrix4x4] | mat4x4[]      | ✅             |
