...
This reads the pointer 3 times: `***BaseSignature`

### Relative Offset Addresses

Use `read_offs32` for RIP-relative addressing (common in x64):

```json
{
  "Addresses": {
    "GlobalData": {
      "signature": "LeaInstruction",
      "read_offs32": true,
      "offset": {
        "windows": 3,
        "linux": 3
...
This is useful when signature points to `lea reg, [rip + offset]` instructions.
