...
::code-group
```csharp [Typical Validation Pattern]
...
```csharp [Check Before Operations]
...
**Tip**: For most gameplay operations, use `IsClientInGame()` - it ensures the player is fully loaded and ready to interact with.
::
