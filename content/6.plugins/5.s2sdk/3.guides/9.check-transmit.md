...
::tabs{variant="card"}
  ...
  public unsafe class Sample : Plugin
  {
      ...
      private void OnCheckTransmit(CheckTransmitInfo*[] infos)
      {
  ...
  public:
      void OnPluginStart() override {
          OnServerCheckTransmit_Register(
              [](const plg::vector<CCheckTransmitInfo*>& infos) {
                  // infos array index represents player slot (0-63)
...
::tabs{variant="card"}
  ...
  ::div{label="c++" icon="vscode-icons:file-type-cpp3"}
  ```cpp
  void OnCheckTransmit(const plg::vector<CCheckTransmitInfo*>& infos) {
      for (size_t playerSlot = 0; playerSlot < infos.size(); playerSlot++) {
