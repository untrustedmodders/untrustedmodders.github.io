...
::card-group
  ...
  ---
  Пишите плагины на C# с помощью языкового модуля .NET в Plugify.
  ::
  ...
  ---
  Пишите лёгкие встраиваемые скрипты с помощью языкового модуля Lua от Plugify.
  ::
  ...
  ---
  *Скоро.* Разрабатывайте плагины на Dlang с помощью языкового модуля Dlang от Plugify.
  ::
