...
---
*Скоро.* Узнайте, как создать плагин с использованием Dlang, экспортировать и импортировать методы, а также интегрировать плагины, написанные на разных языках, в рамках Plugify.
::
